...
export default function PortfolioSection() {
  ...
  return (
    <section
      id="portfolio"
      className="h-screen overflow-y-scroll [&::-webkit-scrollbar]:hidden bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/refs/heads/main/assets/hero/bg-gradient-2.png')] px-6 bg-white dark:bg-zinc-900 pb-16"
    >
      <div className="max-w-6xl pt-5 mx-auto text-center">
        
        <h2 className="flex items-center justify-center gap-10 text-4xl font-bold text-gray-800 dark:text-white mb-12">
          <Link href='/' >
            <Image
