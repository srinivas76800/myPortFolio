      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        >
          ...
          <p className="mt-4  dark:text-gray-500">
            Java full stack, ReactJS Devloper, NextJS Devloper, TailwindCSS, bootstrap, JavaScript, TypeScript.
          </p>
        </motion.div>
      </div>
    </section>
